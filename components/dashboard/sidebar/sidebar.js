    ...
    <aside className="sidebar-nav-wrapper">
      ...
      <nav className="sidebar-nav">
        <ul>
          ...
          <li className="nav-item">
            <Link   href="/mydashboard/qr-management" >
            <a
            
            
            >
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1.66666 4.16667C1.66666 3.24619 2.41285 2.5 3.33332 2.5H16.6667C17.5872 2.5 18.3333 3.24619 18.3333 4.16667V9.16667C18.3333 10.0872 17.5872 10.8333 16.6667 10.8333H3.33332C2.41285 10.8333 1.66666 10.0872 1.66666 9.16667V4.16667Z"></path>
          ...
          <li className="nav-item">
            <Link   href="/mydashboard/id-card-management" >
            <a
            ...
            >
              ...
              <span className="text">Id Card Management</span>
            </a>
            </Link>
          ...
          <li className="nav-item">
            <Link   href="/mydashboard/feedback" >
            <a
            ...
            >
              ...
              <span className="text">Feedback & Suggestions</span>
            </a>
            </Link>
